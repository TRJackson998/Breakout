...
call poetry run pyinstaller .\breakout\__main__.py --noconfirm -F --name breakout --specpath .\build --noconsole --distpath . --add-data ".\..\breakout\textures\*:textures" --add-data ".\..\breakout\sounds\*:sounds"
pause